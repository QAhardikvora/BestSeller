...
public class Login {
	...
	public void register() {
		if (isJackJones == false) {
			wle = new WebElements(driver);
			System.out.println("Boolean value = " + isJackJones);
			wle.login();
		}

		else {
			System.out.println("Boolean value in True condition = " + isJackJones);
			System.out.println("Jack Jones");
		}
	}
